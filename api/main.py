...
import config
from cron import collect_players, collect_competitions, collect_competition_data, collect_clubs, remove_club_list, collect_clubs_fast #, update_competitions #, club0
